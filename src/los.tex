...
\begin{document}
	\begin{tikzpicture}[>=Latex]
        ...
        % ---------- helper NE axis ----------
        % 原点
        \coordinate (O) at (2,10);
        % 坐标箭头
        \draw[->, thick] (O) -- ++(0,2.0) node[above] {North};
        \draw[->, thick] (O) -- ++(2.0,0) node[right] {East};

		% % =================================================
		% % 1. 全局坐标系
		% % =================================================
		% \draw[->,thick] (0,0) -- (18,0) node[below] {Y(East)};
		% \draw[->,thick] (0,0) -- (0,15) node[left]  {X(North)};
		...
		\pgfmathsetmacro{\psiE}{\chiE  + 8}  % 实际航向角 psi
