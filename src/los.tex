...
\begin{document}
	\begin{tikzpicture}[>=Latex]
        ...
        \coordinate (O) at (2,8);
        % 坐标箭头
        \draw[->, thick] (O) -- ++(0,1.6) node[above] {North};
        \draw[->, thick] (O) -- ++(1.6,0) node[right] {East};
		...
		% 2. 路径、当前位置、投影点、LOS点
		% =================================================
		\coordinate (Pk)  at (3, 3);
		\coordinate (Pkp) at (12,9);
		...
		% 你可以手调这两个偏差
		\pgfmathsetmacro{\chiE}{\chiDE + 5}   % 实际航迹角 chi
		\pgfmathsetmacro{\psiE}{\chiE  + 6}  % 实际航向角 psi
